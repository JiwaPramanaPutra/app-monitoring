...
- [x] 4. **Device Management** - CRUD perangkat jaringan (remote reboot menyusul post-v1)
...
- Remote reboot perangkat (SSH/HTTP) - butuh penyimpanan kredensial perangkat yang aman dan spec tersendiri
